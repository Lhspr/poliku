...
if (isset($_POST['cari'])) {  
    $no_rm = $_POST['no_rm'];  
    $query = "SELECT daftar_poli.*, pasien.nama AS nama, jadwal_periksa.hari, periksa.tgl_periksa, periksa.catatan, periksa.biaya_periksa,   
              ...
              GROUP BY periksa.id";  // Mengelompokkan berdasarkan ID pemeriksaan  
