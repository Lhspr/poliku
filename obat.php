...
if (isset($_POST['simpan'])) {
    if (isset($_POST['id'])) {
        ...
        $tambah = mysqli_query($mysqli, "INSERT INTO obat (nama_obat, kemasan, harga, stok) 
            VALUES (
                '" . $_POST['nama_obat'] . "',
                '" . $_POST['kemasan'] . "',
                '" . $_POST['harga'] . "',
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form row" style="width: 30rem;" method="POST" action="" name="myForm"
                        ...
                        <div class="row">
                            ...
                            <div>
                                <input type="text" class="form-control" name="nama_obat" id="inputNama"
                                    placeholder="Nama" value="<?php echo $nama_obat ?>">
                            </div>
                        </div>
                        <div class="row mt-1">
                        ...
                        <div class="row mt-1">
                            ...
                            <div>
                                <input type="text" class="form-control" name="Stok" id="inputStok" placeholder="Stok"
                                    value="<?php echo $Stok ?>">
                            </div>
                        </div>
                ...
                <tr>
                    ...
                    <td class="d-flex justify-content-center ">
                        <div class="d-flex gap-2 mb-3">
                            <a type="button" class="btn btn-success rounded-pill px-3"
                                href="index.php?page=obat&id=<?php echo $data['id'] ?>">
                            ...
                            <a type="button" class="btn btn-danger rounded-pill px-3"
                                href="index.php?page=obat&id=<?php echo $data['id'] ?>&aksi=hapus">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
