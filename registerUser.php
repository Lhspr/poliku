...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($password === $confirm_password) {
        ...
        if ($result->num_rows == 0) {
            ...
            // Memasukkan 'nama' pada query INSERT
            $insert_query = "INSERT INTO user (username, password, nama) VALUES ('$username', '$hashed_password', '$nama')";
            ...
            <div class="col-md-6">
                <div class="detail-box">
                    <div class="heading_container">
                        <h3>Poliklinik Sehat Bahagia!</h3>
                    </div>
                    <p class="aboutpoli">
                        Kami adalah pusat layanan kesehatan yang berkomitmen untuk memberikan pelayanan terbaik kepada
                        pasien kami.
                        Dengan staf medis yang berpengalaman dan fasilitas terkini, Poliklinik Udinus menjadi pilihan
                        utama untuk perawatan kesehatan Anda.
                    </p>
                </div>
            </div>
        </div>
